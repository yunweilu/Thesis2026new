...
\label{eq:fockH}
    ...
    +a_{x}(t)(b+b^\dagger).
\end{equation}
Here, the drive is both longitudinal and transverse; $c$ and $b$ are the annihilation operators for the cavity mode and the transmon mode, respectively, in the same sense as modes $c$ and $b$ in Fig.~\ref{fig:twomode} and Eqs.~\eqref{eq:Hlin_bare}--\eqref{eq:Hnl_bare}. The transmon Kerr nonlinearity is written as in Eq.~\eqref{eq:Hnl_bare}, with $K_b>0$. The parameters $K_b$, $g$, and $\Delta$ denote the Kerr coefficient, interaction strength, and the detuning between the transmon and cavity frequencies. 
...
\begin{figure}[t]
  \includegraphics[width=\linewidth]{chapter4/figures/state.pdf} 
...
\begin{figure}[t]
  \includegraphics[width=\linewidth]{chapter4/figures/gate.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{chapter4/figures/decision_tree.pdf}
