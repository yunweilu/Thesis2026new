...
The noise Hamiltonian $H_{\mathrm{noise}}$ primarily induces dephasing between eigenstates of $H_\text{disp}$ (see Appendix~\ref{Hnoise_transfer}). In particular, because $\bar{\omega}_c$ depends on the detuning $\Delta_{bc}$, FTT-frequency fluctuations $\delta\omega_b(t)$ produce cavity-frequency fluctuations,
\begin{align}
