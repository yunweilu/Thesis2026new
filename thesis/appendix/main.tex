...
\subsection{Quasienergy Operator for the Driven Dispersive Hamiltonian}
...
\subsection{Approximation of Quasienergy and Floquet States}
...
\end{equation}
\subsection{Connection with the RWA}
